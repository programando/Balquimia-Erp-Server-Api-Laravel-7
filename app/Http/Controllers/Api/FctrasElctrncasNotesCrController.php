...
class FctrasElctrncasNotesCrController extends Controller
{
    ...
    private $ApiSoenac ;
      ...
      private function creditNotesToSend ( $Notes ){
        ...
        $this->jsonObjectCreate ($Notes , $otherDataNote  );           
      }


        private function jsonObjectCreate ( $Note, $Others ) {        
            ...
            $this->traitInvoiceLines             ( $Others[0]['products']  , $this->jsonObject, 'credit_note_lines'  );  
        }
