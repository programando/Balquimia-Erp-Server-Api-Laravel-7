<!doctype html><html><head><!-- trx_0048 -->
...
.footerContent a{color:#007C89; font-weight:500; text-decoration:none;}
#button a{text-decoration:none;} /* Necessary for Outlook on Windows Phone */
...
.footerContent p{border-bottom:1px solid #DEDDDC; font-size:13px !important; padding-bottom:20px !important;}
.utilityLink{border-bottom:1px solid #DEDDDC; display:block; font-size:13px !important; padding-top:15px; padding-bottom:15px;}
...
<span style="color:#EFEEEA; display:none; font-size:0px; height:0px; visibility:hidden; width:0px;">Cambio contraseña</span>
<!--[if gte mso 9]>
<table align="center" border="0" cellspacing="0" cellpadding="0" style="width:640px;" width="640">
<tr>
<td align="center" valign="top">
<![endif]-->
<table align="center" border="0" cellpadding="0" cellspacing="0" style="max-width:640px;" width="100%" class="emailContainer">
    <tr>
        <td align="center" valign="top">
            <!-- BEGIN BODY // -->
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td align="left" valign="top" style="padding-top:40px; padding-bottom:30px;">
                                    ...
                                    <img src=""  width="150" class="logoImage" style="border:0; color:#241C15; font-family:'Helvetica Neue', Helvetica, Arial, Verdana, sans-serif; font-size:24px; font-weight:bold; height:auto; letter-spacing:-2px; line-height:100%; text-align:center; outline:none; text-decoration:none;">
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-bottom:20px;" valign="top">
                                    <h1 style="color:#241C15; font-family:Georgia, Times, 'Times New Roman', serif; font-size:22px; font-style:normal; font-weight:400; line-height:36px; letter-spacing:normal; margin:0; padding:0; text-align:left;">Cambio de contraseña para acceso al sistema </h1>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-bottom:20px;" valign="top">
                                    <p style="color:#241C15; font-family:'Helvetica Neue', Helvetica, Arial, Verdana, sans-serif; font-size:16px; font-weight:400; line-height:24px; padding-top:0; margin-top:0; text-align:left;">Para iniciar el cambio de contraseña para ingreso a nuestro sistema, presione click en el botón que se indica a continuación.
