        ...
        <table width="100%" class="mb40">
            <tr>
                ...
                <td width="30%" class="taR">
                    ...
                    <div class="">RÉGIMEN IMPUESTOS SOBRE LAS VENTAS - IVA</div>
                    <div class="">Resolución DIAN N°.: {{ $Resolution['resolution'] }}</div>
                    <div class="">Fecha:  {{ $Resolution['resolution_date'] }}</div>  
                    <div class="">Autorización de Facturación</div>
                    <div class="">{{ $Resolution['prefix'].$Resolution['from']. ' hasta '. $Resolution['prefix'].$Resolution['to']  }}</div>
                </td>
            </tr>
        </table>
